...
<head>
  ...
  <title><?php echo ucwords('Bach Khoa Library Management System'); ?> | <?php echo (isset($x->TableTitle) ? $x->TableTitle : ''); ?></title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-mini"><b>BK</b> MS</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Bach Khoa</b> Library</span>
    </a>
...
<br>
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="dist/img/chutich.png" class="img-circle" alt="User Image">
        </div>
